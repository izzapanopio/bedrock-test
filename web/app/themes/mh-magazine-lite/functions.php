...
if (!function_exists('mh_newsmagazine_custom_scripts')) {
	function mh_newsmagazine_custom_scripts() {
	    wp_enqueue_script('helper-script', get_template_directory_uri(). '/js/helper.js', null, null, true);
	    wp_enqueue_script('ico-calendar-script', get_template_directory_uri(). '/js/ico-calendar.js', array('jquery'), null, true); 
	    wp_enqueue_script('marketcap-script', get_template_directory_uri(). '/js/marketcap.js', array('jquery'), null, true);
...
add_action( 'wp_enqueue_scripts', 'mh_newsmagazine_custom_scripts' );
